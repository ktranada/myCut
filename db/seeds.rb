...
Barber.create!(shop_id: 1, name: "Butters DeSilva")
Barber.create!(shop_id: 1, name: "Harry Potter")
Barber.create!(shop_id: 1, name: "Danny 'Fighter' O'Doyle")
Barber.create!(shop_id: 2, name: "Stella Artois" )
Barber.create!(shop_id: 3, name: "Rocky Balfoa" )
Barber.create!(shop_id: 4, name: "Stella Rosa" )
Barber.create!(shop_id: 4, name: "Hoppy Poppy" )
Barber.create!(shop_id: 2, name: "Mei Knottgood" )
